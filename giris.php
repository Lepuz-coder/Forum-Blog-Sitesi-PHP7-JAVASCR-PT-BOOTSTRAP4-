   ...
   <ul class="navbar-nav mr-auto">
	...
	<?php endif; ?>
	 ...
	 <!--Giriş Yapmamışsa Bunu Göster-->
	  ...
	  <li class="nav-item dropdown navkonum soldandstkp">
	  	<a class="btn btn-primary btn-block text-white active" href="giris.php">Giriş Yap</a>
	  </li>
		  <?php endif; ?>
	  </ul>
  </div>
            ...
            <form class="form-signin" id="giris_form">
              ...
              <div class="form-label-group">
                ...
                <label for="inputPassword">Şifre</label>
				  <span id="sifreUyari"></span>
              </div>
              


              <button class="btn btn-lg btn-primary btn-block text-uppercase" type="button" id="giris_button">Giriş Yap</button>
				              <button class="btn btn-lg btn-primary btn-block text-uppercase disabled" type="button" id="fake_giris_button">Yükleniyor...</button>
